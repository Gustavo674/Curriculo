...
porta_escolhida = inquirer.prompt([inquirer.List("porta", message="Escolha a porta serial que deseja utilizar:", choices=[x.device for x in available_ports])])["porta"]
...
def inicio():
    ...
    perguntas = [inquirer.List("escolha", message="Escolha se quer movimentar o robo ou configurar suas caracteristicas.", choices=["configurações", "movimentações", "sair"])]
