...
class Movimentar():
    ...
    def movimentar(self):
        perguntas = [inquirer.List("escolha", message="Deseja configurar o robô ou realizar movimentações?", choices=["Movimento em X", "Movimento em Y", "Movimento em Z", "Ativar/Desativar ventosa", "Retornar para posição original", "Coordenadas da posição atual","Retornar para escolha", "Pegar medicamento"])]
    ...
    def processar(self, resposta):
        ...
        match(escolha):
            ...
            case "Ativar/Desativar ventosa":
                ...
                return self.continuacao()
            case "Retornar para posição original":
