...
class Configurar():
    ...
    def configurar(self):
        perguntas = [inquirer.List("escolha", message="Deseja mudar a velocidade que seu robo opera?", choices=["Velocidade", "Retornar para escolha"])]
    ...
    def definir_velocidade(self):   
        resposta = int(input("Nova velocidade: "))
